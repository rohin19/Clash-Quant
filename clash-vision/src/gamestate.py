...
# Example usage:
# detections = [
#     {"card": "Giant", "bbox": [100, 200, 150, 250], "confidence": 0.92},
#     {"card": "Goblin", "bbox": [300, 400, 350, 450], "confidence": 0.88}
# ]
# state_engine = GameState()
# state_engine.update(detections)
# print(state_engine.get_state())
